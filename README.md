...
> patrones, pruebas, observabilidad, change management, seguridad) está indexada en
> **[`docs/README.md`](docs/README.md)**, con el informe en [`docs/INFORME.md`](docs/INFORME.md).
